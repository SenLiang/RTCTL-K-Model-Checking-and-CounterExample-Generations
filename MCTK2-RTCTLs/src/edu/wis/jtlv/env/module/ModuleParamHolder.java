...
public class ModuleParamHolder {
	private SMVModule for_instance;	// the module instance this parameter belonging to
	private String local_name;		// the name of formal parameter
	private String init_string;		// the name of actual parameter
