...
type returns[SMVAbstractElementInfo ret]
			...
			| sr=subrange
				{ $ret = intr.mk_range_var(curr_var_name, $sr.ret.elementAt(0), $sr.ret.elementAt(1), input); }
			...
			| ^(TOK_ARRAY sr=subrange ri=type)
				{ $ret = intr.mk_range_array_var(curr_var_name, $ri.ret, $sr.ret.elementAt(0), $sr.ret.elementAt(1), input); }
			;
